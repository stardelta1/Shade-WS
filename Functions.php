  ...
  if ($db -> checkUserExist($email)) {
    ...
    if(!$result){
      ...
      if($mail_result){
        ...
        $response["result"] = "success";
        $response["message"] = "Check your mail for reset password code. (code: ) ".$result["temp_password"];
        return json_encode($response);
...
public function sendEmail($email,$temp_password){
  ...
  $mail->SMTPAuth = true;
  $mail->Username = 'shadeltd@gmail.com';
  $mail->Password = 'shadePassword';
  $mail->SMTPSecure = 'ssl';
  $mail->Port = 465;
 
  $mail->From = 'shadeltd@gmail.com';
  $mail->FromName = 'Shade Ltd.';
  $mail->addAddress($email, 'Shade Ltd.');
 
  $mail->addReplyTo('shadeltd@gmail.com', 'Shade Ltd.');
 
  $mail->WordWrap = 50;
  $mail->isHTML(true);
 
  $mail->Subject = 'Password Reset Request';
  $mail->Body    = 'Hi,<br><br> Your password reset code is <b>'.$temp_password.'</b> . This code expires in 10 minutes. Enter this code within 10 minute to reset your password.<br><br>Thanks,<br>Shade Ltd.';
...
//   $message = 'Hi,\n\n Your password reset code is '.$temp_password.' . This code expires in 10 minutes. Enter this code within 120 seconds to reset your password.\n\nThanks,\Shade Ltd.';
